...
# Read JSON file into Spark dataframe from cloud storage location
...
# Create a new dataframe by selecting all columns from struct column "0"
df_2 = (df_1.select(
                col("0.*"))
       )
